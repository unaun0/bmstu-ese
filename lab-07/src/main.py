...
class MainWindow(QMainWindow):
    ...
    def get_lang_percentages(self):
        return {
            ...
            "JavaScript": float(self.JSPercent.text()),
        }
    ...
    def calculate_fp(self):
        ...
        lang_percentage = self.get_lang_percentages()
        ...
        for lang in language_fp_table:
            self.LOC += (
                normFP
                * (float(lang_percentage[lang]) / 100.0)
                * language_fp_table[lang]
            )
    ...
    def calculate_arch(self):
        ...
        labor = round(
            reduce(lambda x, y: x * y, arch_params_values)
            * 2.45
